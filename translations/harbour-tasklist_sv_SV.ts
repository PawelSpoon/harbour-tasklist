...
<context>
    ...
    <message id="done-label">
        <location filename="../qml/harbour-tasklist.qml" line="59"/>
        <source>Done</source>
    ...
    <message id="pending-label">
        <location filename="../qml/harbour-tasklist.qml" line="61"/>
        <source>Pending</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="new-label">
        <location filename="../qml/harbour-tasklist.qml" line="63"/>
        <source>New</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="today-label">
        <location filename="../qml/harbour-tasklist.qml" line="65"/>
        <location filename="../qml/harbour-tasklist.qml" line="240"/>
        <source>Today</source>
        <extracomment>due date string for today</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="tomorrow-label">
        <location filename="../qml/harbour-tasklist.qml" line="67"/>
        <location filename="../qml/harbour-tasklist.qml" line="244"/>
        <source>Tomorrow</source>
        <extracomment>due date string for tomorrow</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="tags-label">
        <location filename="../qml/harbour-tasklist.qml" line="69"/>
        <location filename="../qml/pages/EditPage.qml" line="313"/>
        <location filename="../qml/pages/EditPage.qml" line="320"/>
        <location filename="../qml/pages/TaskPage.qml" line="55"/>
        <source>Tags</source>
...
title for the tags in the task description (keep as short as possible)</extracomment>
    ...
    <message id="upgrade-label">
        <location filename="../qml/harbour-tasklist.qml" line="111"/>
        <source>Upgrade</source>
        <extracomment>text of the button to migrate the old to the new database format</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="delete-label">
        <location filename="../qml/harbour-tasklist.qml" line="114"/>
        <location filename="../qml/pages/ListPage.qml" line="502"/>
        <location filename="../qml/pages/TagPage.qml" line="221"/>
        <location filename="../qml/pages/TaskPage.qml" line="641"/>
...
menu item to delete the selected task</extracomment>
    ...
    <message id="exit-label">
        <location filename="../qml/harbour-tasklist.qml" line="130"/>
        <source>Exit</source>
        <extracomment>Stop database upgrade dialog</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="upgradedialog-header">
        <location filename="../qml/harbour-tasklist.qml" line="133"/>
        <source>Action required</source>
        <extracomment>get user&apos;s attention before starting database upgrade</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="information-label">
        <location filename="../qml/harbour-tasklist.qml" line="139"/>
        <location filename="../qml/pages/ExportPage.qml" line="279"/>
...
headline for information about import/export mechanism</extracomment>
    ...
    <message id="upgrade-description-part1">
        <location filename="../qml/harbour-tasklist.qml" line="147"/>
    ...
    <message id="upgrade-description-part2">
        <location filename="../qml/harbour-tasklist.qml" line="150"/>
    ...
    <message id="option-header">
        <location filename="../qml/harbour-tasklist.qml" line="159"/>
        <location filename="../qml/pages/sync/DropboxSync.qml" line="72"/>
    ...
    <message id="choose-option-label">
        <location filename="../qml/harbour-tasklist.qml" line="167"/>
    ...
    <message id="every-day-label">
        <location filename="../qml/localdb.js" line="65"/>
        <source>Daily</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="every-workday-label">
        <location filename="../qml/localdb.js" line="67"/>
        <source>Worksdays</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="every-week-label">
        <location filename="../qml/localdb.js" line="69"/>
        <source>Weekly</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="every-month-label">
        <location filename="../qml/localdb.js" line="71"/>
        <source>Monthly</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="about-label">
        <location filename="../qml/pages/AboutPage.qml" line="63"/>
        <location filename="../qml/pages/TaskPage.qml" line="492"/>
        <source>About</source>
...
menu item to jump to the application information page</extracomment>
    ...
    <message id="edit-task-label">
        <location filename="../qml/pages/EditPage.qml" line="152"/>
...
saves the current made changes to user options</extracomment>
    ...
    <message id="task-properties-label">
        <location filename="../qml/pages/EditPage.qml" line="161"/>
    ...
    <message id="task-open-label">
        <location filename="../qml/pages/EditPage.qml" line="189"/>
    ...
    <message id="list-label">
        ...
        <location filename="../qml/pages/TaskPage.qml" line="44"/>
        <source>List</source>
...
title for the list property in the task description (keep as short as possible)</extracomment>
    ...
    <message id="priority-label">
        <location filename="../qml/pages/EditPage.qml" line="219"/>
        <source>Priority</source>
        <extracomment>select the tasks priority</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="dates-label">
        <location filename="../qml/pages/EditPage.qml" line="238"/>
        <source>Dates</source>
        <extracomment>headline for the date and time properties of the task</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="due-date-label">
        <location filename="../qml/pages/EditPage.qml" line="250"/>
        <location filename="../qml/pages/TaskPage.qml" line="49"/>
        <source>Due</source>
...
title for the due date in the task description (keep as short as possible)</extracomment>
    ...
    <message id="repeat-label">
        <location filename="../qml/pages/EditPage.qml" line="287"/>
        <source>Repeat</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="created-date-label">
        <location filename="../qml/pages/EditPage.qml" line="307"/>
        <source>Created</source>
        <extracomment>displays the date when the task has been created by the user</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="notes-label">
        <location filename="../qml/pages/EditPage.qml" line="338"/>
        <location filename="../qml/pages/TaskPage.qml" line="60"/>
        <source>Notes</source>
...
title for the notes in the task description (keep as short as possible)</extracomment>
    ...
    <message id="notes-placeholder">
        <location filename="../qml/pages/EditPage.qml" line="346"/>
    ...
    <message id="internal-storage-label">
        <location filename="../qml/pages/ExportPage.qml" line="78"/>
        <source>Internal storage</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="sdcard-label">
        <location filename="../qml/pages/ExportPage.qml" line="83"/>
    ...
    <message id="export-file-placeholder">
        <location filename="../qml/pages/ExportPage.qml" line="143"/>
    ...
    <message id="export-button">
        <location filename="../qml/pages/ExportPage.qml" line="159"/>
        <source>Export data</source>
        <extracomment>headline for the data export section</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="data-export-success">
        <location filename="../qml/pages/ExportPage.qml" line="170"/>
    ...
    <message id="data-export-path">
        <location filename="../qml/pages/ExportPage.qml" line="172"/>
        <source>File path</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="select-file-header">
        <location filename="../qml/pages/ExportPage.qml" line="182"/>
    ...
    <message id="export-import-description">
        <location filename="../qml/pages/ExportPage.qml" line="288"/>
    ...
    <message id="drop-database-header">
        <location filename="../qml/pages/ExportPage.qml" line="294"/>
    ...
    <message id="drop-database-warning">
        <location filename="../qml/pages/ExportPage.qml" line="303"/>
    ...
    <message id="drop-database-confirmation">
        <location filename="../qml/pages/ExportPage.qml" line="312"/>
    ...
    <message id="drop-database-button">
        <location filename="../qml/pages/ExportPage.qml" line="320"/>
        <source>Drop database</source>
        <extracomment>Button to import data form the selected file</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="drop-database-success">
        <location filename="../qml/pages/ExportPage.qml" line="327"/>
    ...
    <message id="list-add-error-detail">
        <location filename="../qml/pages/ListPage.qml" line="250"/>
        <source>It already exists.</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="lists-header">
        <location filename="../qml/pages/ListPage.qml" line="267"/>
        <source>Your lists</source>
        <extracomment>headline for the user created lists</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="deleting-label">
        <location filename="../qml/pages/ListPage.qml" line="282"/>
        <location filename="../qml/pages/TagPage.qml" line="121"/>
        <location filename="../qml/pages/TaskPage.qml" line="511"/>
...
deleting a task via displaying a remorse element (a Sailfish specific interaction element to stop a former started process)</extracomment>
    ...
    <message id="default-label">
        <location filename="../qml/pages/ListPage.qml" line="304"/>
        <source>default</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="cover-label">
        <location filename="../qml/pages/ListPage.qml" line="307"/>
        <source>Cover</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="save-changes-description">
        <location filename="../qml/pages/ListPage.qml" line="375"/>
        <location filename="../qml/pages/TagPage.qml" line="150"/>
...
a label to inform the user how the changes on a tag can be saved</extracomment>
    ...
    <message id="edit-label">
        <location filename="../qml/pages/ListPage.qml" line="440"/>
        <location filename="../qml/pages/TagPage.qml" line="208"/>
        <location filename="../qml/pages/TaskPage.qml" line="630"/>
        <source>Edit</source>
...
menu item to switch to the page where the selected task can be modified</extracomment>
    ...
    <message id="set-default-list-label">
        <location filename="../qml/pages/ListPage.qml" line="454"/>
    ...
    <message id="set-cover-list-label">
        <location filename="../qml/pages/ListPage.qml" line="470"/>
    ...
    <message id="to-clipboard-label">
        <location filename="../qml/pages/ListPage.qml" line="486"/>
        <source>Copy to clipboard</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="list-not-copied-warning">
        <location filename="../qml/pages/ListPage.qml" line="494"/>
        <source>List not copied</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="list-empty-description">
        <location filename="../qml/pages/ListPage.qml" line="496"/>
    ...
    <message id="settings-label">
        ...
        <location filename="../qml/pages/TaskPage.qml" line="434"/>
...
menu item to switch to settings page</extracomment>
    ...
    <message id="db-sync-interrupt-label">
        <location filename="../qml/pages/sync/DropboxSync.qml" line="66"/>
    ...
    <message id="remote-replace-label">
        <location filename="../qml/pages/sync/DropboxSync.qml" line="80"/>
    ...
    <message id="local-replace-label">
        <location filename="../qml/pages/sync/DropboxSync.qml" line="89"/>
    ...
    <message id="db-sync-replace-description">
        <location filename="../qml/pages/sync/DropboxSync.qml" line="98"/>
    ...
    <message id="select-tags-header">
        <location filename="../qml/pages/TagDialog.qml" line="68"/>
        <source>Select tags</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="confirm-button">
        <location filename="../qml/pages/TagDialog.qml" line="70"/>
        <source>Confirm</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="tagspage-header">
        <location filename="../qml/pages/TagPage.qml" line="66"/>
        <source>Manage tags</source>
        <extracomment>headline for the tags page</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="new-tag-label">
        <location filename="../qml/pages/TagPage.qml" line="72"/>
        <source>Add new tag</source>
        <extracomment>headline to create new tags</extracomment>
        <translation type="unfinished"></translation>
    </message>
    <message id="tagname-placeholder">
        <location filename="../qml/pages/TagPage.qml" line="80"/>
    ...
    <message id="new-tag-confirmation-description">
        <location filename="../qml/pages/TagPage.qml" line="83"/>
    ...
    <message id="deleting-done-tasks-label">
        <location filename="../qml/pages/TaskPage.qml" line="132"/>
    ...
    <message id="reseting-done-tasks-label">
        <location filename="../qml/pages/TaskPage.qml" line="151"/>
    ...
    <message id="new-task-confirmation-description">
        <location filename="../qml/pages/TaskPage.qml" line="308"/>
    ...
    <message id="task-reopened-success">
        <location filename="../qml/pages/TaskPage.qml" line="331"/>
    ...
    <message id="task-reopened-success-details">
        <location filename="../qml/pages/TaskPage.qml" line="333"/>
        <source>The task already existed and was marked as done.</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="task-not-added-warning">
        <location filename="../qml/pages/TaskPage.qml" line="339"/>
    ...
    <message id="task-not-added-warning-details">
        <location filename="../qml/pages/TaskPage.qml" line="341"/>
        <source>It already exists on this list.</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="task-multiadd-label">
        <location filename="../qml/pages/TaskPage.qml" line="371"/>
    ...
    <message id="tasks-added-success">
        <location filename="../qml/pages/TaskPage.qml" line="383"/>
    ...
    <message id="details-label">
        <location filename="../qml/pages/TaskPage.qml" line="386"/>
    ...
    <message id="tasks-exist-warning-details">
        <location filename="../qml/pages/TaskPage.qml" line="395"/>
        <source>No new tasks have been added to the list.</source>
        <translation type="unfinished"></translation>
    </message>
    <message id="orientation-lock-label">
        <location filename="../qml/pages/TaskPage.qml" line="424"/>
    ...
    <message id="reset-done-tasks-label">
        <location filename="../qml/pages/TaskPage.qml" line="467"/>
    ...
    <message id="mark-done-label">
        <location filename="../qml/pages/TaskPage.qml" line="553"/>
